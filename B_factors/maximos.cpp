...
double A14[m][4];
double A14t[n][546];
ifstream miFichero9("b_factor_Ca_15.csv");
double A15[m][4];
double A15t[n][546];
ifstream miFichero10("b_factor_Ca_16.csv");
double A16[m][4];
double A16t[n][546];
ifstream miFichero110("b_factor_Ca_17.csv");
double A17[m][4];
double A17t[n][546];
ifstream miFichero120("b_factor_Ca_18.csv");
double A18[m][4];
double A18t[n][546];
ifstream miFichero130("b_factor_Ca_19.csv");
double A19[m][4];
double A19t[n][546];
ifstream miFichero14("b_factor_Ca_20.csv");
double A20[m][4];
double A20t[n][546];
